...
export default class TextColor implements InlineTool {
  ...
  private customSurround(color: string) {
    const termWrapper = this.api.selection.findParentTag(this.tag, TextColor.CSS);
  ...
  public wrap(color?: string) {
    ...
    span.classList.add(TextColor.CSS);
  ...
  public checkState(): boolean {
    const termTag = this.api.selection.findParentTag(this.tag, TextColor.CSS);
